...
class SearchRestaurantPage extends StatefulWidget {
  ...
  SearchRestaurantPage({Key key, this.latitude, this.longitude})
      : super(key: key);
  @override
  SearchRestaurantPageState createState() => new SearchRestaurantPageState();
}

class SearchRestaurantPageState extends State<SearchRestaurantPage> {
  TextEditingController _searchRestaurant;
  ...
  initState() {
    super.initState();
    _searchRestaurant = new TextEditingController();
  }
                          ...
                          child: new TextField(
                            ...
                            onChanged: (text) {
                              if (text.isNotEmpty) {
                                ...
                                setState(() {
                                  _searchRestaurant.text = "";
                                });
                              }
                            },
                          ),
                        ),
                        _searchRestaurant.text.isNotEmpty
                            ? Expanded(
                                flex: 0,
                                child: IconButton(
                                  onPressed: () {

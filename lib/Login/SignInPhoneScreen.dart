...
class SignInPhoneScreen extends StatefulWidget {
  @override
  createState() => new SignInPhoneScreenState();
}
    ...
    if (form.validate()) {
      ...
      if(_username.length == 0) {
        ...
        if (!regex.hasMatch(_username)) {
          setState(() {
            _errorMsg = "Entrer un email valide";
            _showError = true;
          });
        }else {
          setState((){
          ...
          _presenter.doLogin(_username, _password, true);
        }
      }
...
//                        },
                  ...
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.only(
                          ...
                          right: padding_from_screen),
                      child:
                      new Text('Saisissez votre adresse mail',
                          style: new TextStyle(
  ...
  void onLoginSuccess(Client client) async {
    ...
    Navigator.of(context).push(new MaterialPageRoute(
        builder: (context) => SignInPasswordScreen(email: _username)));
  }
